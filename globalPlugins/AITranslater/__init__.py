...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
    ...
    def script_layer_help(self, gesture):
        self.record_live_speech = False
        msg = [
            "Halo! Gunakan tombol-tombol di bawah ini setelah kamu menekan kombinasi utama (NVDA + Shift + Alt + T):",
            "-" * 30,
            "F1  : Menampilkan bantuan.",
            "R : Nyalakan atau matikan Terjemahan Otomatis (Real-time).",
            "T : Ketik teks secara manual untuk diterjemahkan.",
            "S : Masuk ke Pengaturan Khusus add-on.",
            "A : Cek koneksi, mesin terjemahan, dan sisa kuota/Token kamu.",
            "C : Terjemahkan teks yang baru saja  disalin dari Clipboard.",
            "L : Terjemahkan ucapan atau teks terakhir.",
            "Esc : keluar dari menu bantuan.",
            "",
            "Ingat ya: Tekan dulu shortcut utama, baru tekan tombol huruf di atas..",
            "Semua shortcut huruf kecil di atas DITEKAN SETELAH menekan shortcut utama.",
            "",
